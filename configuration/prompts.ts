...
If the excerpts given do not contain any information relevant to the user's question, do not say something along the lines of "While not directly discussed in the documents that ${OWNER_NAME} provided me with, I can explain based on my own understanding" then proceed to answer the question based on your knowledge of ${OWNER_NAME} and just answer something based on your knowledge.
